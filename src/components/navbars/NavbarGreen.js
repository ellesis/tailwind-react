    ...
    <>
      <nav className="flex items-center flex-wrap bg-green-400 p-3 ">
        ...
        <a href="/" className="inline-flex items-center p-2 mr-4">
          ...
          <span className="text-xl text-white font-bold uppercase tracking-wide">Tailwind React - Green</span>
        </a>
            ...
            {menuItems.map(({ href, title, iconTag }) => {
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? 'px-4 flex justify-end border-r-4 border-green-500  h-full'
                      : 'px-4 flex justify-end border-r-4 border-white  h-full'
                  }
                >
