  ...
  return (
    <>
      ...
      <div className="mb-4 text-gray-700">
        <label className="block mb-1" for="forms-validationInputCode_error">
          Password
        </label>
        <input
          className="w-full h-10 px-3 text-base placeholder-gray-600 border border-red-700 rounded-lg focus:shadow-outline"
          type="password"
      ...
      <div className="text-gray-700">
        <label className="block mb-1" for="forms-validationInputCode_success">
          Password
        </label>
        <input
          className="w-full h-10 px-3 text-base placeholder-gray-600 border border-green-500 rounded-lg focus:shadow-outline"
          type="password"
