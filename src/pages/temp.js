      ...
      <header className='flex items-center'>
        ...
        <div className='container pl-8'>
          <div className='flex items-center'>
            ...
            <button className='ml-auto sm:hidden mr-2' onClick={this.handleMenuClick.bind(this)}>
      ...
      <main>
        <div className='text-center mt-10'>
          ...
          <p className='font-bold mt-3'>
            Reduce your window to show the{' '}
            <span className='text-indigo-800 font-bold'>
              hamburger menu <i className='ml-2 fas fa-bars fill-current text-indigo-800 text-2xl' />
            </span>
          </p>
        </div>
